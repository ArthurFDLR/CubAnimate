...
class CColorPicker(QDialog):
    ...
    def initUi(self):
        ...
        # 信息
        self.colorInfos = CColorInfos(False, QColor(255,255,255), self.colorView)
        ...
        clayout.addWidget(QPushButton(
            'Confirm', self, clicked=self.accept, objectName='confirmButton'))
        clayout.addWidget(QPushButton(
            'Cancel', self, clicked=self.reject, objectName='cancelButton'))
